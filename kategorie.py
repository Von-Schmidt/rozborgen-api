temamotiv = """Nyní dostaneš kategorii, která je součástí velkého, již hotového rozboru. Tvým úkolem je precizně vypracovat pouze následující kategorii a nic jiného.\n\n

kategorie 1: téma a motiv\n\n
    ...
    \ttéma = námět; ústřední myšlenka díla\n
        ...
        \t\ttéma je pouze jeden bod, ne více\n
...
kategorie musí být formátován přesně podle následujícího příkladu:\n\n


    - Téma: Ruský venkov po revoluci\n
    - Motivy: Chudoba, láska, válka, komunismus\n\n
    
Veškeré fakta a informace ber z následujícího příkladu. Jedná se o předešlé zpracování rozboru:\n\n"""

casoprostor = """Nyní dostaneš kategorii, která je součástí velkého, již hotového rozboru. Tvým úkolem je precizně vypracovat pouze následující kategorii a nic jiného.\n\n

kategorie 2: časoprostor\n\n
...
kategorie musí být formátován přesně podle následujícího příkladu:\n\n
    ...
    - Československo, okolí řeky Berounky\n\n
    
Veškeré fakta a informace ber z následujícího příkladu. Jedná se o předešlé zpracování rozboru:\n\n"""

kompozice = """Nyní dostaneš kategorii, která je součástí velkého, již hotového rozboru. Tvým úkolem je precizně vypracovat pouze následující kategorii a nic jiného.\n\n

kategorie 3: kompoziční výstavba\n\n

    \tkompoziční výstavba = způsob řazení a spojení témat v knize\n
        \t\trozhodneme, který ze způsobů autor knihy využil, a svoje tvrzní zdůvodníme:
            \t\t\t- chronologický postup – děj plyne za sebou, jednotlivé události příběhu jsou uváděny od nejstarších po nejmladší (například Petr a Lucie)
            \t\t\t- retrospektivní postup – příběh je uváděn v obráceném pořadí, případně jsou do chronologického vyprávění vsunuty retrospektivní pasáže (například Babička – babiččino vzpomínání na manžela)
...
kategorie musí být formátován přesně podle následujícího příkladu:\n\n
    ...
    - chronologický postup – děj plyne za sebou, jednotlivé události příběhu jsou uváděny od nejstarších po nejmladší\n
    - 8 kapitol\n\n
    
Veškeré fakta a informace ber z následujícího příkladu. Jedná se o předešlé zpracování rozboru:\n\n"""

druhzanr = """Nyní dostaneš kategorii, která je součástí velkého, již hotového rozboru. Tvým úkolem je precizně vypracovat pouze následující kategorii a nic jiného.\n\n

kategorie 4: literární druh a žánr
    ...
    \tliterární žánr:
        \t\t- lyrické – óda, elegie, epigram,... a další
        \t\t- lyricko-epické – balada, romance, poéma,... a další
        \t\t- epické – román, povídka, novela, bajka, pohádka, báje, pověst,... a další
...
lyrickysubjekt = """Nyní dostaneš kategorii, která je součástí velkého, již hotového rozboru. Tvým úkolem je precizně vypracovat pouze následující kategorii a nic jiného.\n\n

kategorie 5: vypravěč / lyrický subjekt
...
postava = """Nyní dostaneš kategorii, která je součástí velkého, již hotového rozboru. Tvým úkolem je precizně vypracovat pouze následující kategorii a nic jiného.\n\n

kategorie 6: postavy

    \tjmenujte hlavní postavy, které v knize vystupují a charakterizujte je:
        \t\tkladná/neutrální/záporná
		\t\tstručně jejich role v ději
		\t\tvztah k ostatním postavám
        
kategorie musí být formátován přesně podle následujícího příkladu:\n\n

    - Miloš Hrma - hlavní postava, kladná, děj se točí kolem jeho problémů a zážitků, chodí s Mášou\n\n
    
Veškeré fakta a informace ber z následujícího příkladu. Jedná se o předešlé zpracování rozboru:\n\n"""

zpusoby = """Nyní dostaneš kategorii, která je součástí velkého, již hotového rozboru. Tvým úkolem je precizně vypracovat pouze následující kategorii a nic jiného.\n\n

kategorie 7: vyprávěcí způsoby
...
promluvy = """Nyní dostaneš kategorii, která je součástí velkého, již hotového rozboru. Tvým úkolem je precizně vypracovat pouze následující kategorii a nic jiného.\n\n
